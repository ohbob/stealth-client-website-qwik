...
import { fetchPosts, findPostBySlug } from "~/utils/docs";
    ...
    <Resource
      ...
      onResolved={(post: Post) => (
        ...
        // <section class="mx-auto py-8 sm:py-16 lg:py-20">
          <section class="grid grid-cols-12 mx-auto container">
          ...
          <article class="col-span-10">
            ...
            <div
              class="prose-md prose-headings:font-heading prose-headings:leading-tighter container prose prose-md mx-auto mt-8 max-w-3xl px-6 prose-headings:font-bold prose-headings:tracking-tighter prose-a:text-primary-600 prose-img:rounded-md prose-img:shadow-lg dark:prose-invert dark:prose-headings:text-slate-300 dark:prose-a:text-primary-400 sm:px-6 lg:prose-md"
...
export const head: DocumentHead = ({ resolveValue }) => {
  ...
  return {
    title: `${post.title} — Stealth Client`,
    meta: [
      {
        name: "description",
